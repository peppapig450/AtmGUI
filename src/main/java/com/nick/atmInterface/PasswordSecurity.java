...
public class PasswordSecurity {
    ...
    /**
     * Iteration can be changed without breaking existing hashes.
     */
    ...
    public void configure(Properties props) {
        if (props.getProperty(PARAM_HASH_BYTE_SIZE) != null) {
            setHashByteSize(Integer.parseInt(props.getProperty(PARAM_HASH_BYTE_SIZE)));
        }
        if (props.getProperty(PARAM_SALT_BYTE_SIZE) != null) {
            setSaltByteSize(Integer.parseInt(props.getProperty(PARAM_SALT_BYTE_SIZE)));
        }
        ...
        if (props.getProperty(PARAM_PBKDF2_ITERATIONS) != null) {
            setPbkdf2Iterations(Integer.parseInt(props.getProperty(PARAM_PBKDF2_ITERATIONS)));
        }
        if (props.getProperty(PARAM_SECURE_RANDOM_ALGORITHM) != null) {
            setSecureRandomAlgorithm(props.getProperty(PARAM_SECURE_RANDOM_ALGORITHM));
        }
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((pbkdf2Algorithm == null) ? 0 : pbkdf2Algorithm.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PasswordSecurity other = (PasswordSecurity) obj;
